...
public class PDFGeneratorService : IPDFGeneratorService
{
    ...
    private async void AgregarInformesAlPDF(Document document, List<Informe> informes)
    {
    ...
    private async void AgregarInforme(Document document, string tituloInforme, Informe informe)
    {
        if (informe == null)
        {
